      ...
      switch (_l.label) {
        case 0:
          ...
          ((_a = req.query),
            ...
            (_d = _a.status),
            (status_1 = _d === void 0 ? "" : _d),
            (_e = _a.canteenId),
            (canteenId = _e === void 0 ? "" : _e),
            (_f = _a.startDate),
            (startDate = _f === void 0 ? "" : _f),
            (_g = _a.endDate),
            (endDate = _g === void 0 ? "" : _g),
            (_h = _a.mealType),
            (mealType = _h === void 0 ? "" : _h));
          query = {};
          if (
            ((_k = req.user) === null || _k === void 0 ? void 0 : _k.role) ===
            "canteen"
          ) {
          ...
          if (status_1) query.status = status_1;
          if (mealType) query.mealType = mealType;
          if (startDate || endDate) {
            query.mealDate = {};
            if (startDate) query.mealDate.$gte = new Date(startDate);
            if (endDate) {
              end = (0, dayjs_1.default)(endDate).add(1, "day").toDate();
        ...
        case 1:
          ...
          if (
            ...
            order.canteenId.toString() !==
              ((_b = req.user.canteenId) === null || _b === void 0
                ? void 0
                : _b.toString())
          ) {
            return [
...
router.post(
  "/",
  (0, auth_1.requireRoles)("admin", "worker"),
  function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
      var _a,
        elderlyId,
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            _e.trys.push([0, 8, , 9]);
            ((_a = req.body),
              (elderlyId = _a.elderlyId),
              (canteenId = _a.canteenId),
              (mealDate = _a.mealDate),
              (mealType = _a.mealType),
              (mealStandard = _a.mealStandard),
              (_b = _a.remark),
              (remark = _b === void 0 ? "" : _b),
              (_c = _a.deliveryType),
              (deliveryType = _c === void 0 ? "pickup" : _c));
          ...
          case 1:
            ...
            if (!elderly) {
              return [
                2 /*return*/,
                res.status(404).json({ message: "老人信息不存在" }),
              ];
            }
          ...
          case 2:
            ...
            if (!canteen) {
              return [
                2 /*return*/,
                res.status(404).json({ message: "助餐点不存在" }),
              ];
            }
            ...
            if (!mealPrice) {
              return [
                2 /*return*/,
                res.status(400).json({ message: "无效的餐标" }),
              ];
            }
            ...
            if (mealDateObj < tomorrow) {
              return [
                2 /*return*/,
                res.status(400).json({ message: "只能预订次日及以后的餐食" }),
              ];
            }
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              MonthlySubsidyQuota_1.MonthlySubsidyQuota.findOne({
                month: monthKey,
              }),
            ];
          case 4:
          ...
          case 8:
            ...
            res
              .status(500)
              .json({ message: error_3.message || "创建订单失败" });
            return [3 /*break*/, 9];
          case 9:
            return [2 /*return*/];
        }
...
router.patch(
  "/:id/status",
  (0, auth_1.requireRoles)("admin", "canteen"),
  function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
      var status_2,
        validStatuses,
        ...
        switch (_c.label) {
          case 0:
            ...
            if (!validStatuses.includes(status_2)) {
              return [
                2 /*return*/,
                res.status(400).json({ message: "无效的订单状态" }),
              ];
            }
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              SubsidyRecord_1.SubsidyRecord.findOne({
                orderId: order._id,
              }),
            ];
          case 3:
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            _d.trys.push([0, 5, , 6]);
            ((_a = req.body),
              (volunteerName = _a.volunteerName),
              (estimatedTime = _a.estimatedTime));
            return [4 /*yield*/, Order_1.Order.findById(req.params.id)];
          case 1:
            order = _d.sent();
            if (!order) {
            ...
            if (
              ((_b = req.user) === null || _b === void 0 ? void 0 : _b.role) ===
                "canteen" &&
              order.canteenId.toString() !==
                ((_c = req.user.canteenId) === null || _c === void 0
                  ? void 0
                  : _c.toString())
            ) {
              return [
